...
public class ProductService {
    ...
    @Transactional
    public void saveProduct(@RequestBody ProductReqDto productReqDto) {
    ...
    @Transactional
    public void updateProduct(long id, ProductReqDto productReqDto) {
        Product product = productRepository.findById(id).orElseThrow();
        product.update(productReqDto);
    }
